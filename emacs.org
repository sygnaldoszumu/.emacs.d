   ...
   #+begin_src emacs-lisp
	...
	'(
	  ("d" "default" plain
	   ...
	   :unnarrowed t)
	  ("n" "Nutrition")
	  ("nf" "Food" plain (file "~/Org/templates/food.org")
	   :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n")
	   :unnarrowed t)
	  ("nr" "Recipe" plain (file "~/Org/templates/recipe.org")
	   :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n")
	   :unnarrowed t)
	  ("nm" "Meals" table-line (file+olp "~/Roam/nutrition.org" "Meals")(file "~/Org/templates/meals.org")
	   :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n")
	   :unnarrowed t)
	  ))
       :config
  ...
  (setq org-capture-templates
	'(
	  ("i" "Inbox" entry (file "~/Org/inbox.org")
	   "* %i%? \n")
	  ("I" "Add m" plain (file "~/Org/meals.org")
	   "%(ns/load-last-file-line (org-roam-node-file (org-roam-node-read)))")
...
#+begin_src emacs-lisp
  ...
  ;; (global-set-key (kbd "C-c C-0") #'org-capture-at-point)
 #+end_src
** org-habit-plus
 #+begin_src emacs-lisp
